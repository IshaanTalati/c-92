...
function send() {
	...
	var questiona = "<h4 id='word_display'> Q. "+remove_charAt3+"</h4>";
	var inputbox = "<br> Answer: <input type ='text' id='inputboxx'> ";
	var send_button = "<br><br><button class='btn btn-info' onclick='check()'>Check</button>";
	var row = questiona + inputbox + send_button;
	document.getElementById ("output").innerHTML= row  
}
var question_turn = "player1"
var answer_turn = "player2"
function check() {
var checks = document.getElementById("inputboxx").value
var answerr = checks.toLowerCase()
if (answerr == word ) 
{
